package org.example.zhc.util.zhc.validation.reflection;

import lombok.SneakyThrows;
import org.example.zhc.util.Log;
import org.example.zhc.util.zhc.validation.reflection.internal.Bird;
...
public class ReflectApp {
    ...
    @Test
    public void getAll(){
        Class reflectClass = Class.forName("org.example.zhc.util.zhc.validation.reflection.Class2Reflected");
